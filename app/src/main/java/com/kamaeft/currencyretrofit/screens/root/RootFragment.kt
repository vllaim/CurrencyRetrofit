package com.kamaeft.currencyretrofit.screens.root
...
import com.kamaeft.currencyretrofit.ViewPagerAdapter
...
class RootFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        TabLayoutMediator(view.tab_layout, view.view_pager){
            ...
            when(pos){
                0 -> {
                    tab.setIcon(R.drawable.ic_baseline_currency_ruble_24)
                }
                1->{
